...
model = dict(
    ...
    backbone=dict(
        ...
        sync_bn=False, out_indices=(1, 2, 3, 4), pretrained='../pretrained/emo2_20M.pth', frozen_stages=-1, norm_eval=False,),
    decode_head=dict(in_channels=448, channels=256, num_classes=150),
