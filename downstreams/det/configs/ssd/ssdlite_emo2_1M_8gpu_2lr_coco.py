...
model = dict(
    ...
    backbone=dict(
        ...
        sync_bn=False, out_indices=(3, 4), pretrained='../pretrained/emo2_1M.pth', frozen_stages=-1, norm_eval=True,),
    neck=dict(
        type='SSDNeck',
        in_channels=(80, 180),
        out_channels=(80, 180, 512, 256, 256, 128),
    ...
    bbox_head=dict(
        type='SSDHead',
        in_channels=(80, 180, 512, 256, 256, 128),
        num_classes=80,
        use_depthwise=True,
        norm_cfg=dict(type='BN', eps=0.001, momentum=0.03),
        act_cfg=dict(type='ReLU6'),
